...
namespace CleanArchitecture.Infraestructure.Migrations
{
    ...
    [Migration("20250905143750_InitialCreate")]
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasIndex("AlquilerId")
                        .HasDatabaseName("ix_review_alquiler_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_review_user_id");

                    b.HasIndex("VehiculoId")
                        .HasDatabaseName("ix_review_vehiculo_id");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Reviews.Review", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Alquileres.Alquiler", null)
                        .WithMany()
                        .HasForeignKey("AlquilerId")
                        .HasConstraintName("fk_review_alquileres_alquiler_id1");

                    b.HasOne("CleanArchitecture.Domain.Users.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_review_user_user_temp_id1");

                    b.HasOne("CleanArchitecture.Domain.Vehiculos.Vehiculo", null)
                        .WithMany()
                        .HasForeignKey("VehiculoId")
                        .HasConstraintName("fk_review_vehiculo_vehiculo_temp_id");
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Roles.RolePermission", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Permissions.Permission", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_roles_permissions_permission_permissions_id");
                    ...
                    b.HasOne("CleanArchitecture.Domain.Roles.Role", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_roles_permissions_role_role_id");
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Users.UserRole", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Roles.Role", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_users_roles_role_role_id");
